  ...
  return (
    <>
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        '@type': 'Person',
        name: 'Thomas Sander',
        url: 'https://haustechnik-stellenangebote.de/autor/thomas-sander',
        jobTitle: 'Gründer & Geschäftsführer',
        worksFor: {
          '@type': 'Organization',
          name: 'Social Media Venture GmbH',
          url: 'https://haustechnik-stellenangebote.de',
        },
        description: 'HR-Tech-Experte und Gründer spezialisierter Jobportale für Fachkräfte in Deutschland.',
        knowsAbout: ['HR-Tech', 'Recruiting', 'Jobportale', 'Haustechnik', 'Personalwesen'],
        address: {
          '@type': 'PostalAddress',
            ...
            <div className="bg-gradient-to-br from-sky-800 to-slate-900 p-8 md:p-12">
              <div className="flex flex-col sm:flex-row items-center sm:items-start gap-6">
                ...
                <div className="text-center sm:text-left">
                  ...
                  <p className="text-sky-100/80 text-sm">Social Media Venture GmbH, Schliemannstraße 23, 10437 Berlin</p>
                </div>
              </div>
            </div>
            ...
            <div className="p-8 md:p-12 space-y-10">
              ...
              <section>
                ...
                <div className="text-slate-600 leading-relaxed space-y-4">
                  ...
                  <p>
                    Unter seiner Leitung ist haustechnik-stellenangebote.de zu einer führenden Anlaufstelle für Haustechnik-Stellenangebote in Deutschland, Österreich und der Schweiz geworden.
                  </p>
                </div>
              </section>
              ...
              <section>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  {[
                    ...
                    { title: 'Haustechnik-Branche', desc: 'Branchenspezifisches Know-how und Netzwerk im Haustechnik-Bereich' },
